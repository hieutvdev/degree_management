        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripion = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Honors = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGraduateds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentGraduateds_Majors_MajorId",
                        column: x => x.MajorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentGraduatedId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Degrees_StudentGraduateds_StudentGraduatedId",
                        column: x => x.StudentGraduatedId,
                        principalTable: "StudentGraduateds",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Degrees_StudentGraduatedId",
                table: "Degrees",
                column: "StudentGraduatedId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGraduateds_MajorId",
